<template>
  <div class="information-inner information-change">
    <h1 class="information-title active">反馈意见</h1>
    ...
    >
      ...
      <div class="examineInfo">
        <h1 class="examineInfo-title">反馈意见</h1>
      </div>
      <el-form
        ref="dialogForm"
        :model="dialogParams"
      ...
      >
        <el-row :gutter="24">
          <el-col :span="24">
            <el-form-item label="意见标题：" prop="reportTitle">
              <el-input
        ...
        <el-row :gutter="24">
          <el-col :span="24">
            <el-form-item label="反馈时间：" prop="reportTime">
              <el-date-picker
        ...
        <el-row :gutter="24">
          <el-col :span="24">
            <el-form-item label="意见电子件：" prop="reportFile">
              <upload
                ref="uploadFile"
                accept=".doc, .docx, .pdf"
                :limit="1"
        ...
        <el-row :gutter="24">
          <el-col :span="24">
            <el-form-item label="反馈内容摘要：" prop="reportContent">
              <el-input
                type="textarea"
                v-model="dialogParams.reportContent"
                placeholder="请输入反馈内容摘要"
                maxlength="240"
                show-word-limit
                rows="4"
      ...
      <div class="manage-info">
        <div class="info-item">
          <div class="info-item-quare">
            <span class="info-item-title">意见标题：</span>
        ...
        <div class="info-item">
          <div class="info-item-quare">
            <span class="info-item-title">反馈时间：</span>
            <span class="info-item-content">{{ dialogParams.reportTime }}</span>
          </div>
        </div>
        <div class="info-item">
          <div class="info-item-quare">
            <span class="info-item-title">意见电子件：</span>
            <span
        ...
        <div class="info-item">
          <div class="info-item-quare">
            <span class="info-item-title">反馈内容摘要：</span>
            <span class="info-item-content">{{
...
export default {
  ...
  data() {
    return {
      ...
      dialogRules: {
        reportTitle: [{ required: true, message: "请输入意见标题" }],
        reportTime: [{ required: true, message: "请选择选择时间" }],
        reportFile: [{ required: true, message: "请上传意见电子件" }],
        reportContent: [{ required: true, message: "请输入反馈内容摘要" }]
      },
      check: false,
  ...
  methods: {
    async getList() {
      ...
      reponse.data.list&&reponse.data.list.map(item=>{
    ...
    async getDialogInfo(id) {
      ...
      this.dialogParams.reportTime = subject.reportTime.split(" ")[0];
