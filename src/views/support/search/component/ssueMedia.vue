    ...
    dailogSubmit() {
      this.$refs.dialogForm.validate(async (valid) => {
        if (valid) {
          ...
          this.dialogParams.photoFileIds =
            this.dialogParams.photoFileIds.join(",");
          this.dialogParams.mideaFileIds =
            this.dialogParams.mideaFileIds.join(",");
          this.dialogParams.soundFileIds =
            this.dialogParams.soundFileIds.join(",");
          this.dialogParams.electFileIds =
            this.dialogParams.electFileIds.join(",");
