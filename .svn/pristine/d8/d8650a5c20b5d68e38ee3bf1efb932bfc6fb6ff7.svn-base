<template>
  <div>
    ...
    <div class="clue-info">
      ...
      <div class="clue-item clue-item-paper" v-if="workArry.length>0">
        <div class="clue-item-quare clue-item-inspect">
          <span class="clue-item-label">
            <i class="clue-import">*</i>相关证书：
          </span>
          <div class="clue-item-file">
            <div class="clue-item-file-group" v-for="(item,index) in workArry" :key="index">
              <span class="accounChunk">{{item.name}}</span>
              <el-button size="mini" @click="handlePreviewClick(item.attachmentId)">预览</el-button>
              <el-button
                size="mini"
                @click="handleDownLoadDoc(item.attachmentId)"
                type="primary"
              >下载</el-button>
            </div>
          </div>
      ...
      <div class="clue-item clue-item-paper" v-if="inspectArry.length>0">
        <div class="clue-item-quare clue-item-inspect">
          <span class="clue-item-label">
      ...
      <div class="clue-item clue-item-paper" v-if="spotArry.length>0">
        <div class="clue-item-quare clue-item-inspect">
          <span class="clue-item-label">
      ...
      <div class="clue-item clue-item-paper" v-if="mediaArry.length>0">
        <div class="clue-item-quare clue-item-inspect">
          <span class="clue-item-label">
      ...
      <div class="clue-item clue-item-paper" v-if="clueTrackDTOList.length>0">
        <div class="clue-item-quare clue-item-inspect">
          <span class="clue-item-label">
...
export default {
  ...
  methods: {
    ...
    async getInfo() {
      ...
      this.manageInfo.time = xcTeamInfo.xcStartDate
        ? xcTeamInfo.xcStartDate + xcTeamInfo.xcEndDate
        : undefined;
      ...
      if (subject.szList) {
        const workArry = [];
        const workList = subject.szList;
        for (const item in workList) {
          const subject = workList[item];
          workArry.push({
