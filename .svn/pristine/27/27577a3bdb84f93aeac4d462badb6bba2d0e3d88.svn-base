<template>
  <div>
    ...
    <el-table v-loading="loading" :data="List" border :stripe="true">
      ...
      <el-table-column label="会议地点" :show-overflow-tooltip="true" width="200px">
        <template v-slot="scope">
      ...
      <el-table-column label="汇报稿" width="200px">
