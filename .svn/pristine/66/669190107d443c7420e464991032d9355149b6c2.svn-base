  ...
  <div class="information-inner information-change">
    ...
    <div class="tab-list-content">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="目录名称：">
                <el-input v-model="queryParams.businessTypeName" placeholder="请输入目录名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="目录编码：">
                <el-input v-model="queryParams.businessTypeNumber" placeholder="请输入目录编码"></el-input>
              </el-form-item>
            </el-col>
      ...
      <el-table v-loading="loading" :data="List" border :stripe="true">
        ...
        <el-table-column label="资料名称" :show-overflow-tooltip="true" min-width="250px">
        ...
        <el-table-column
          ...
          width="100px"
        ></el-table-column>
        <el-table-column prop="areaName" label="所属地区" width="100px"></el-table-column>
        <el-table-column prop="uploadTime" label="上传时间" width="100px"></el-table-column>
        <el-table-column prop="fromPerson" :show-overflow-tooltip="true" label="上传人" width="100px"></el-table-column>
        <el-table-column prop="fromUnit" :show-overflow-tooltip="true" label="上传单位" width="100px"></el-table-column>
        <el-table-column label="电子件预览" width="250px" :show-overflow-tooltip="true">
          <template v-slot="scope">
            <span
              class="accounChunk"
        ...
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="所属地区名：" prop="areaCode">
              <el-select v-model="dialogParams.areaCode" filterable placeholder="请选择所属地区名">
                <el-option
      ...
      <div class="dialogCheck">
        <el-row :gutter="24">
          <el-col :span="12">
            ...
            <span class="check-text">{{ dialogParams.businessTypeName }}</span>
          </el-col>
          <el-col :span="12">
            <label class="check-label">所属地区名：</label>
            <span class="check-text">{{ dialogParams.areaName }}</span>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="24">
...
export default {
  ...
  methods: {
    ...
    dailogSubmit() {
      this.$refs.dialogForm.validate(async valid => {
        if (valid) {
          ...
          this.dialogParams.businessTypeName = undefined;
    ...
    async getDialogInfo(id) {
      ...
      this.dialogParams.businessTypeName = subject.businessTypeName;
