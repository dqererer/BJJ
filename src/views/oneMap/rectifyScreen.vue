    ...
    <div class="styem-content" :style="{ height: contentAllH + 'px' }">
      <div class="styem-content-left">
        <div class="styem-ctop">
          ...
          <div
            class="styem-ctop-content ctop-box"
            :style="{ height: taskContentH + 'px' }"
          >
            <span
              class="ctop-item"
        ...
        <div class="styem-ctop">
          ...
          >
            <div
              class="styem-ctop-content-box"
              id="polluteSortEchart"
              v-show="polluteBoolean"
            ></div>
          </div>
          <i class="ctop-border ctop-left-top"></i>
          <i class="ctop-border ctop-right-top"></i>
        ...
        <div class="styem-ctop">
          ...
          <div
            ...
            :style="{ height: accountContentH + 'px' }"
          >
      ...
      <div class="styem-content-center">
        ...
        <div class="styem-ctop" style="padding: 0 1%">
          ...
          <div
            class="styem-ctop-content"
            :style="{ height: appearContentH + 'px' }"
          >
            <div
              class="styem-ctop-content-box"
              id="appearEchart"
              v-show="appearBoolean"
            ></div>
          </div>
          <i class="ctop-border ctop-left-top"></i>
          <i class="ctop-border ctop-right-top"></i>
    ...
    handlePolluteSortEchart() {
      ...
      let option = {
        radar: {
          ...
          splitArea: {
            areaStyle: {
              color: ["#494b54", "#363d58", "#27315e", "#1d2752", "#162358"],
              shadowColor: "#27315e",
              shadowBlur: 0,
            },
          },
        ...
        series: [
          {
            ...
            itemStyle: {
              normal: {
                color: "#2196f3", // 图表中各个图区域的边框线拐点颜色
                lineStyle: {
                  color: "#055798", // 图表中各个图区域的边框线颜色
                },
                areaStyle: {
                  type: "default",
                },
