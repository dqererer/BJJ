...
export default {
  ...
  methods: {
    ...
    async getBriefInfo() {
      ...
      const startTime = this.queryParams.startTime + " 00:00:00";
      const endTime = this.queryParams.endTime + " 23:59:59";
      const reponse = await homeBriefInfo({ batchId, startTime, endTime });
    ...
    async getWorkInfo() {
      ...
      const startTime = this.queryParams.startTime + " 00:00:00";
      const endTime = this.queryParams.endTime + " 23:59:59";
      const reponse = await hometWorkInfo({ batchId, startTime, endTime });
      const subject = reponse.data;
    ...
    async getSinkTeamList() {
      ...
      const startTime = this.queryParams.startTime + " 00:00:00";
      const endTime = this.queryParams.endTime + " 23:59:59";
      const reponse = await homeSinkTeamList({ batchId, startTime, endTime });
