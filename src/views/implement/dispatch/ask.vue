  ...
  <div class="information-inner information-change">
    ...
    <div class="tab-list-content">
      <div class="box-body" v-show="showSearch">
        <el-form :model="queryParams" label-width="120px">
          ...
          ><el-row>
            ...
            <el-col :span="8" v-else><div style="height: 10px"></div></el-col>
      ...
      <el-table v-loading="loading" :data="List" border :stripe="true">
        ...
        >
        <el-table-column label="督察信息" min-width="300px">
          ...
          <el-col :span="24">
            <el-form-item label="整改任务：" prop="accountSourceId">
              ...
              >
                ...
                >
                  <el-popover
                    v-if="item.rectifyContent.length >= 68"
                    placement="top-start"
                    width="400"
                    trigger="hover"
                  >
                    ...
                    <span slot="reference">{{
                      item.rectifyContent.slice(0, 65) + "..."
                    }}</span>
                  </el-popover>
  ...
  methods: {
    ...
    getTaskArray: function () {
      getTaskList({
        ...
        res.data[0].rectifyContent =
          "发飞洒。发发飞洒发，收发飞洒。发发飞洒发，收发飞洒发发。飞洒发，收发飞洒发。发飞洒发，收发飞洒发。发飞洒发，收发。飞洒发发飞洒发，收发飞洒发发飞洒发，收发飞洒发发飞洒发，收发飞洒发发飞洒发，收";
