<template>
  <div class="information-inner information-change">
    <h1 class="information-title active">调阅资料</h1>
    <div class="tab-list-content">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="资料名称：">
                <el-input v-model="queryParams.infoName" placeholder="请输入资料名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="资料类型：">
                <el-select v-model="queryParams.documentType" placeholder="请选择资料类型">
                  <el-option
      ...
      <el-table v-loading="loading" :data="List" border :stripe="true">
        ...
        <el-table-column
          ...
          class="column-left"
        ></el-table-column>
        <el-table-column prop="infoName" label="资料名称" :show-overflow-tooltip="true" width="280px"></el-table-column>
        <el-table-column
          prop="accessRequire"
          :show-overflow-tooltip="true"
          label="提供要求"
          width="160px"
        ></el-table-column>
        <el-table-column prop="lastTime" label="最迟提供时间" width="110px"></el-table-column>
        <el-table-column prop="whetherProvideName" label="是否提供" width="80px"></el-table-column>
        <el-table-column prop="number" label="资料编号" :show-overflow-tooltip="true" width="120px"></el-table-column>
        <el-table-column prop="fileNumber" label="资料文号" width="120px"></el-table-column>
        <el-table-column :show-overflow-tooltip="true" prop="fromUnit" label="提供单位" width="160px"></el-table-column>
        <el-table-column prop="provideTime" label="提供时间" width="160px"></el-table-column>
        <el-table-column prop="infoNum" label="资料份数" width="80px"></el-table-column>
        <el-table-column label="操作" width="180" fixed="right">
          <template slot-scope="scope" v-if="buttonAuthority">
            <el-button size="mini" type="primary" @click="handleRegister(scope.row)">资料登记</el-button>
    ...
    >
      ...
      >
        ...
        <el-row :gutter="24">
          <el-col :span="24">
            <el-form-item label="资料名称：" prop="infoNameList">
              <div
                class="report-box"
        ...
        <el-button type="primary" size="small" @click="handleChildClick">新增</el-button>
    ...
    >
      ...
      >
        ...
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="资料类型：" prop="documentType">
              <el-select v-model="registerParams.documentType" filterable placeholder="请选择资料类型">
                <el-option
                  v-for="item in documentArry"
                  :key="item.id"
                  :label="item.label"
        ...
        <div class="dialogFormFooter">
          <el-button type="primary" @click="dailogRegisterSubmit">保存</el-button>
          <el-button type="primary" @click="handleRegisterClose">关闭</el-button>
        </div>
      </el-form>
    </el-dialog>
    <import-dialog
...
export default {
  ...
  methods: {
    ...
    handleNewly() {
      ...
      this.dialogParams.infoNameList = [{ infoName: "" }];
    },
    handleDialogClose() {
      this.open = false;
    },
    ...
    async handleRegister(data) {
      ...
      this.registerParams.infoName = infoName;
      if (whetherProvide == 1) {
