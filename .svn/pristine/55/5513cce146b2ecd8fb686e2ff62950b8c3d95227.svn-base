<template>
  <div class="information-inner information-change">
    ...
    <div class="tab-list-content">
      <national-info @nameChange="getList" :teamId.sync="queryParams.inspectTeam"></national-info>
      ...
      <div class="manage-info">
        <div class="info-item">
          <div class="info-item-quare">
            <span class="info-item-title">标题：</span>
        ...
        <div class="info-item">
          <div class="info-item-quare">
            <span class="info-item-title">简报期号：</span>
            <span class="info-item-content">{{ dialogParams.issueNum }}</span>
          </div>
        </div>
        <div class="info-item">
          <div class="info-item-quare">
            <span class="info-item-title">简报日期：</span>
            <span class="info-item-content">{{ dialogParams.reportDate }}</span>
          </div>
        </div>
        <div class="info-item">
          <div class="info-item-quare">
            <span class="info-item-title">简报文件：</span>
            <span
...
export default {
  ...
  methods: {
    ...
    handleDownloadClick(fileId) {
      const teamId = this.queryParams.inspectTeam;
