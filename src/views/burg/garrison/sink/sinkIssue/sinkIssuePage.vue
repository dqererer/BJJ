      ...
      <el-table v-loading="loading" :data="List" border :stripe="true">
        ...
        >
          <template v-slot="scope">
            ...
            >{{ scope.row.problemDescript }}</span>
          </template>
        </el-table-column>
        <el-table-column
          prop="problemContent"
        ...
        <div class="manage-info manage-infoNo">
          <div class="info-item">
            ...
            <span class="info-item-content">
              <el-button size="mini" :disabled="curStatus == 'view'" type="primary" @click="handleAlready()">选择已有线索</el-button>
            </span>
          </div>
          <div class="info-item">
            ...
            <div class="info-item-content">
              <ul class="info-item-list">
                ...
                >
                  ...
                  <span class="clue-close" v-if="curStatus != 'view'" @click="handleClueClose(index)">X</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="线索来源：">
              <el-input
                :disabled="true"
                v-model="dialogAlreadyParams.clueSourceName"
              ></el-input>
            </el-form-item>
          </el-col>
        </el-row>
...
import inspectIndexPreview from "./inspectIndexPreview2";
import spotIndexPreview from "./spotIndexPreview2";
import mediaIndexPreview from "./mediaIndexPreview2";
export default {
  components: {
    examineInfo,
    nationalInfo,
