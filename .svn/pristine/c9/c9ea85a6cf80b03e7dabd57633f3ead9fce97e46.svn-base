  ...
  <div class="information-inner information-change">
    ...
    <div class="tab-list-content">
      ...
      <el-table v-loading="loading" :data="List" border :stripe="true">
        ...
        <el-table-column label="线索名称" :show-overflow-tooltip="true" min-width="200px">
        ...
        <el-table-column prop="clueNum" label="线索编号" :show-overflow-tooltip="true" width="160px"></el-table-column>
        ...
        <el-table-column prop="clueContent" :show-overflow-tooltip="true" label="线索内容" min-width="200px"></el-table-column>
        ...
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="重点关注：" prop="weatherFocus">
              <el-radio-group v-model="dialogParams.weatherFocus" placeholder="请选择重点关注">
...
export default {
  ...
  methods: {
    ...
    async handleEdit({ id }) {
      this.dialogTitle = "修改";
      const state = await this.handleThreadCanChange(id,"修改");
      if (!state) {
        return;
      }
      this.open = true;
    ...
    async handleThreadCanChange(id,text) {
      const reponse = await threadCanChange({ id });
      const data = reponse.data;
      if (!data) {
        this.$message.error(`该线索已经被后续业务调用，不允许${text}`);
      }
      return data;
    },
    ...
    handleDelete(data) {
      this.$confirm("是否要删除", "确认信息", {
        ...
        const { id } = data;
        const state = await this.handleThreadCanChange(id,"删除");
        if (!state) {
          return;
        }
