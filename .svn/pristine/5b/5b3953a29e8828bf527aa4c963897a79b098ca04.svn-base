<template>
  <div>
    <national-info
      :teamId.sync="queryParams.superviseGroupId"
    ...
    <div class="box-body" v-show="showSearch">
      <el-form :model="queryParams" label-width="120px">
        <el-row>
          <el-col :span="8">
            <el-form-item label="转往地区：">
              <el-select v-model="queryParams.citys" placeholder="请选择转往地区">
                <el-option
    ...
    >
      ...
      <el-table-column prop="toUnit" label="转往单位" width="160px"></el-table-column>
      <el-table-column label="转办来电" width="160px">
        <template scope="scope">
          <span
            class="accounChunk"
      ...
      <el-table-column label="转办来信" width="160px">
        <template scope="scope">
          <span
            class="accounChunk"
      ...
      <el-table-column prop="dealPerson" label="经办人" width="160px"></el-table-column>
      <el-table-column prop="acceptPerson" label="接收人" width="160px"></el-table-column>
      <el-table-column prop="transferTime" label="转办时间" width="160px"></el-table-column>
      <el-table-column label="签章转办单" width="160px">
        <template slot-scope="scope" v-if="scope.row.uploadFlag == 1">
...
import { dictName, dictListType } from "@/api/styem/dict/type";
...
export default {
  ...
  methods: {
    ...
    handleDownloadClick(fileId) {
      const teamId = this.queryParams.superviseGroupId;
