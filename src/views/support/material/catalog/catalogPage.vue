<template>
  <div class="information-inner information-change">
    ...
    <div class="tab-list-content">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="目录名称：">
                <el-input v-model="queryParams.name" placeholder="请输入目录名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="目录编码：">
                <el-input v-model="queryParams.number" placeholder="请输入目录编码"></el-input>
              </el-form-item>
            </el-col>
      ...
      >
        <el-table-column prop="name" label="目录名称" min-width="200px" class="column-left"></el-table-column>
        <el-table-column prop="number" label="目录编码" width="180px"></el-table-column>
        <el-table-column prop="describe" label="目录描述" width="180px"></el-table-column>
        <el-table-column prop="sort" label="排序" width="180px"></el-table-column>
      ...
      >
        ...
        <el-row :gutter="10">
          <el-form-item label="目录排序：" prop="sort">
            <el-input type="number" v-model="dialogParams.sort" placeholder="请输入目录排序"></el-input>
          </el-form-item>
        </el-row>
        <el-row :gutter="10">
...
export default {
  ...
  methods: {
    async getList() {
      ...
      const menu =
        reponse.data &&
        this.handleTree(reponse.data, "id", "parentId", "children", "0");
      this.List = menu;
      this.loading = false;
    },
    async getMenuList() {
