        ...
        <div style="position: relative">
          ...
          >
            <p
              ...
              "
            >
              来电:{{ tipTypeData.subjectTipPhone }}件
            </p>
            <p
              style="
              ...
              "
            >
              来信:{{ tipTypeData.subjectTipLetter }}件
            </p>
          </div>
        </div>
    ...
    <div class="styem-content-center" :style="{ height: centerH + 'px' }">
      <div class="styem-content-inner">
        ...
        >
          ...
          <div class="content-center-show" :style="fixBox">
      ...
      <div class="round-process">
        ...
        >
          ...
          <span class="process-text"
            >{{ item.roundName }}{{ item.batchName }}</span
          >
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    fixBox: function () {
      if (this.middleArry.length == 9) {
        return {
          height: "50px",
          width: "80px",
        };
      } else if (this.middleArry.length < 3) {
        return {
          height: "72px",
          width: "120px",
        };
      } else if (this.middleArry.length == 11) {
        return {
          height: "48px",
          width: "78px",
        };
  ...
  methods: {
    ...
    async getRightChartData() {
      ...
      for (const archiveItem in subject.archiveList) {
        ...
        imgShow("/center/file/downloadFile", subjectArchive.path).then(
          (src) => {
            temp.archImgSrc = src;
          }
        );
