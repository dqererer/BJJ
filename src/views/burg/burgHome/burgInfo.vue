        ...
        <div class="home-box bulletin-box">
          ...
          <div class="home-box-bottom">
            <p class="bulletin-section">
              ...
              >{{tiemDate}}</template>
              <span v-for="(item, index) in briefInfoObj.transferMap" :key="index">
              ...
              <template v-if="briefInfoObj.latterCountyCountMap.length>0">从区域分布来看，</template>
              <span v-for="(itemb,indexb) in briefInfoObj.latterCountyCountMap" :key="itemb.name">
                <template
                  v-if="indexb == briefInfoObj.latterCountyCountMap.length-1"
            ...
            <p class="bulletin-section">
              ...
              >按照污染类型,</template>
              <span v-for="(itemc,indexc) in briefInfoObj.phonePollutionMap" :key="indexc">
                <template
              ...
              <span v-for="(itemd,indexd) in briefInfoObj.phoneCityCountMap" :key="indexd">
                <template
...
export default {
  ...
  methods: {
    ...
    async getBriefInfo() {
      ...
      this.briefInfoObj.latterCountyCountMap = subject.latterCountyCountMap||[];
    ...
    handleCheckAllChange(val) {
      ...
      if (this.checkedCities.length > 0) {
        const countyCode = this.checkedCities.join(",");
        this.tipParams.countyCode = countyCode;
      } else {
        this.tipParams.countyCode = undefined;
      }
      this.getTipInfo();
    },
    getAllCitys() {
