        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="手机号码：" prop="telephone">
              <el-input
                v-model="dialogParams.telephone"
                placeholder="请输入手机号码"
              ></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="是否有督察组长资格：" prop="leaderAlternative">
              <el-select
                v-model="dialogParams.leaderAlternative"
                placeholder="是否有督察组长资格"
              >
                <el-option label="是" value="1"></el-option>
                <el-option label="否" value="0"></el-option>
              </el-select>
          ...
          <el-col :span="12">
            <el-form-item label="是否是督察成员：" prop="memberAlternative">
              <el-select
                v-model="dialogParams.memberAlternative"
                placeholder="是否是督察成员"
              >
                <el-option label="是" value="1"></el-option>
                <el-option label="否" value="0"></el-option>
...
<script>
import  People  from "../../../support/search/peopleComponent.vue";
import {
  personnelList,
  personnelDelete,
  personnelSave,
