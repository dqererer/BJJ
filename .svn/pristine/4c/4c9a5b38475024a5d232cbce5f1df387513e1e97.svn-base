    ...
    <section>
      ...
      <el-descriptions class="manage-info" :column="3" border>
        <el-descriptions-item label="办结情况" label-class-name="my-label">
          {{ handleInfo && handleInfo.finishFlagName }}
        </el-descriptions-item>
        <el-descriptions-item label="办结时间">
          {{ handleInfo && handleInfo.finishTime }}
        </el-descriptions-item>
        <el-descriptions-item label="属实情况">
          {{ handleInfo && handleInfo.trueFlagName }}
        </el-descriptions-item>
        <el-descriptions-item label="区域分布">
          {{ handleInfo && handleInfo.areaName }}
        </el-descriptions-item>
        <el-descriptions-item label="处理和整改情况" :span="3">
          {{ handleInfo && handleInfo.dealReform }}
        </el-descriptions-item>
        <el-descriptions-item label="调查核实情况" :span="3">
          {{ handleInfo && handleInfo.investiCheck }}
        </el-descriptions-item>
        <el-descriptions-item label="利益关系">
          {{ handleInfo && handleInfo.interestRelationshipName }}
        </el-descriptions-item>
        <el-descriptions-item label="群众身边">
          {{ handleInfo && handleInfo.aroundMasses }}
        </el-descriptions-item>
        <el-descriptions-item label="问责情况">
          {{ handleInfo && handleInfo.questioningSituation }}
        </el-descriptions-item>
        <el-descriptions-item label="是否公开">
          {{ handleInfo && handleInfo.openFlagName }}
        </el-descriptions-item>
        <el-descriptions-item label="公开时间">
          {{ handleInfo && handleInfo.openTime }}
        </el-descriptions-item>
        <el-descriptions-item label="公开地址">
          {{ handleInfo && handleInfo.openAddr }}
        </el-descriptions-item>
        <el-descriptions-item label="责令整改（家）">
          {{ handleInfo && handleInfo.orderReform }}
        </el-descriptions-item>
        <el-descriptions-item label="立案处罚（家）">
          {{ handleInfo && handleInfo.punishment }}
        </el-descriptions-item>
        <el-descriptions-item label="罚款金额（元）">
          {{ handleInfo && handleInfo.fine }}
        </el-descriptions-item>
        <el-descriptions-item label="立案侦查（件）">
          {{ handleInfo && handleInfo.lawcase }}
        </el-descriptions-item>
        <el-descriptions-item label="约谈（人）">
          {{ handleInfo && handleInfo.interview }}
        </el-descriptions-item>
        <el-descriptions-item label="行政拘留（人）">
          {{ handleInfo && handleInfo.adminDetain }}
        </el-descriptions-item>
        <el-descriptions-item label="刑事拘留（人）">
          {{ handleInfo && handleInfo.criminalDetain }}
        </el-descriptions-item>
      </el-descriptions>
    </section>
  </div>
