<template>
  <div>
    ...
    <div v-if="!reportBoolean&&checkBoolean">
      <div class="accpet-top">
        <div class="accpet-top-box">
          <span
            class="accpet-btn accpet-check"
    ...
    <check-page v-if="tabName == 2"></check-page>
    <no-accpet v-if="tabName == 3"></no-accpet>
    <agree-page v-if="tabName == 4"></agree-page>
    <no-manage v-if="tabName == 5"></no-manage>
    <case-transact :reportBoolean="reportBoolean" v-if="tabName == 6"></case-transact>
