  ...
  <div>
    <div class="files-more" v-if="filesMoreBoolean">
      <div class="files-title">
        <h1 class="files-title-name">案卷信息列表</h1>
      ...
      <div class="files-inner">
        ...
        <div class="files-content" style="overflow: auto">
          <ul v-infinite-scroll="load" infinite-scroll-distance="20" infinite-scroll-delay="400">
            <li
              class="files-item"
...
export default {
  ...
  data() {
    return {
      ...
      noMore: false,
      lookOpen: false,
      bugrPopFilesBoolean: false,
    };
  },
  methods: {
    handleBurgFilesCloseClick() {
      this.bugrPopFilesBoolean = false;
    },
