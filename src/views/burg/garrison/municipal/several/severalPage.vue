    ...
    <div class="tab-list-content">
      ...
      <el-table v-loading="loading" :data="List" border :stripe="true">
        ...
        <el-table-column label="谈话安排情况">
          ...
          <el-table-column label="谈话地点" :show-overflow-tooltip="true" width="260px">
        ...
        <el-table-column label="操作" width="240" fixed="right">
          <template v-slot="scope">
            <div v-if="scope.row.whetherTalk == 0 && buttonAuthority">
              <el-button size="mini" type="success" @click="handleRecord(scope.row)">新增记录</el-button>
        ...
        <el-row :gutter="24">
          <el-col :span="24">
            <el-form-item label="谈话地点：" class="meet-address" prop="arrangeAddress">
              ...
              <el-select v-model="dialogParams.arrangeCountyCode" filterable placeholder="请选择区县">
                <el-option
    ...
    >
      ...
      <div class="manage-info">
        ...
        <div class="info-item">
          ...
          <div class="info-item-content">
            <ul class="info-item-list">
              <li class="info-item-item accounChunk" v-for="(item, index) in clewList" :key="index">
                <span @click.stop="handleClewClick(item.clueId)">{{ index + 1 }}、{{ item.clueName }}</span>
