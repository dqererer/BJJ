<template>
  <div class="information-inner information-change">
    <h1 class="information-title active">暂不转办</h1>
    <div class="tab-list-content">
      ...
      <el-row :gutter="10" class="mb8">
        <div v-if="buttonAuthority" style="display:inline-block">
          ...
          <el-button size="small" @click="handleNoManage" type="danger">不受理</el-button>
        </div>
      ...
      >
        ...
        <el-table-column label="操作" width="260" fixed="right">
          <template slot-scope="scope" v-if="buttonAuthority">
            ...
            <el-button size="mini" type="danger" @click="handleStripNoManage(scope.row)">不受理</el-button>
        ...
        <el-row :gutter="24">
          <el-col :span="24">
            <el-form-item label="拟办意见：" prop="proposal">
              <el-input type="textarea" v-model="dialogManageParams.proposal" placeholder="请输入拟办意见"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    <el-dialog
      ...
      :close-on-click-modal="false"
    >
      <p class="noAccpet-text" v-if="noManageBoolean">
        本次选中
      ...
      <div class="manage-info">
        ...
        <div class="info-item">
          <div class="info-item-quare">
            ...
            <span class="info-item-content">是</span>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    handleStripNoManage(data) {
      const { id } = data;
      this.dialogNoAccpetParams.idList = [id];
      this.noAccpetOpen = true;
      this.noManageBoolean = false;
    },
