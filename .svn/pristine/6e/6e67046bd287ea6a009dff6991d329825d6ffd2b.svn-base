        ...
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="电话：" prop="actualIntervieweePhone">
              <el-input v-model="dialogParams.actualIntervieweePhone" disabled placeholder="请输入电话"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
...
import spotPreview from "../../../burg/garrison/sink/sinkIssue/spotPreview";
export default {
  props: {
    spotOpen: {
      type: Boolean
  ...
  methods: {
    ...
    async getPersonList(code) {
      const reponse = await severalPersonList({teamId:this.inspectId});
