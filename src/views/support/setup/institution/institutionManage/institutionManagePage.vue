<template>
  <div class="information-inner information-styem" ref="informationInner">
    ...
    >
      ...
      <el-tab-pane :label="tabState == 'add' ? '机构添加' : '机构修改'" name="add">
        <institution-manage-amend :officeListData="officeListData" @backHandle="backHandle"></institution-manage-amend>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
