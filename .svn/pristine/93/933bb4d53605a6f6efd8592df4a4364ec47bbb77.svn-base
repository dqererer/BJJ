    ...
    >
      ...
      <div class="manage-info">
        ...
        <div class="info-item" v-if="pollutionLevelBoolean">
          <div class="info-item-quare">
            <span class="info-item-title">主要污染类型：</span>
            <span class="info-item-content">{{ auditInfo.pollutionLevelOneReviewName }}-{{auditInfo.pollutionLevelTwoReviewName}}</span>
          </div>
        </div>
        <div class="info-item" v-if="pollutionLevelBoolean">
          <div class="info-item-quare">
...
export default {
  ...
  data() {
    return {
      ...
      auditInfo: {
        ...
        subPollutionLevelOneReviewName: undefined,
        subPollutionLevelTwoReviewName: undefined,
  ...
  methods: {
    ...
    async getauditInfo(id) {
      ...
      this.auditInfo.subPollutionLevelOneReviewName = subject.subPollutionLevelOneReviewName;
      this.auditInfo.subPollutionLevelTwoReviewName = subject.subPollutionLevelTwoReviewName;
