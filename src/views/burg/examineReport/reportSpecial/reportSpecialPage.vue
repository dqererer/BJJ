  ...
  <div class="information-inner information-change">
    ...
    <div class="tab-list-content">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="方案标题：">
                <el-input v-model="queryParams.reportTitle" placeholder="请输入方案标题"></el-input>
              </el-form-item>
            </el-col>
      ...
      <el-table v-loading="loading" :data="List" border :stripe="true">
        ...
        <el-table-column :show-overflow-tooltip="true" label="督察报告草拟标题" min-width="200px">
        ...
        <el-table-column prop="reportTime" label="报告时间" width="160px"></el-table-column>
