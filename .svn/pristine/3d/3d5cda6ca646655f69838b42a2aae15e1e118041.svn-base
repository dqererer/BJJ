<template>
  <div class="information-inner information-styem" ref="informationInner">
    <el-tabs
      ...
      @tab-click="tabClick"
      ref="tabs"
      class="information-styem-tab"
    >
      <el-tab-pane label="角色列表" name="list">
        <role-manage-list ref="dataList" @handleSeeAmend="handleSeeAmend" @backHandle="backHandle"></role-manage-list>
      </el-tab-pane>
      <el-tab-pane :label="tabState == 'add' ? '角色添加' : '角色修改'" name="add">
        <role-manage-amend :officeListData="officeListData" @backHandle="backHandle"></role-manage-amend>
      </el-tab-pane>
      <el-tab-pane label="角色分配" name="see">
        <role-manage-allot :officeListData="officeListData" @backHandle="backHandle"></role-manage-allot>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
