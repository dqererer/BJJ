<template>
  <div>
    <national-info  @nameChange="getList" :teamId.sync="queryParams.teamId"></national-info>
    ...
    <el-table v-loading="loading" :data="List" border :stripe="true">
      ...
      <el-table-column prop="infoName" label="资料名称" :show-overflow-tooltip="true" min-width="200px"></el-table-column>
      ...
      <el-table-column prop="fileName" label="查阅电子件名称" width="120px"></el-table-column>
      ...
      <el-table-column prop="typeName" label="调阅方式" width="160px"></el-table-column>
    </el-table>
    <pagination
      v-show="total > 0"
      :total="total"
